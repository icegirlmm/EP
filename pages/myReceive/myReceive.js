...
Page({
  ...
  getReceiveList: function () {
    let that = this;
    wx.request({
      url: app.globalData.url + "/order/getReceiveList",
      data: {
  ...
  cancelOrder: function (e) {
    ...
    console.log(e);
    wx.request({
      url: app.globalData.url + '/order/receiverCancelOrder',
      method: "POST",
      data: {
        orderId: orderId
      },
  ...
  confirmFinish: function (e) {
    ...
    console.log(e);
    wx.request({
      url: app.globalData.url + '/order/receiverConfirmOrder',
      method: "POST",
      data: {
        orderId: orderId
      },
  ...
  deleteRecord: function (e) {
    ...
    console.log(e);
    wx.request({
      url: app.globalData.url + '/order/receiverDeleteOrder',
      method: "POST",
      data: {
        orderId: orderId
      },
